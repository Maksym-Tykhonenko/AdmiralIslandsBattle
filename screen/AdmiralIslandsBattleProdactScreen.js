...
const AdmiralIslandsBattleProdactScreen = ({navigation, route}) => {
  ...
  const userAgent = `Mozilla/5.0 (Linux; Android 11; ${deviceInfo.deviceModel}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Mobile Safari/537.36`;
...
export default AdmiralIslandsBattleProdactScreen;
